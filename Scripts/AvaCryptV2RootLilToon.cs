...
namespace GeoTetra.GTAvaCrypt
{
    public class AvaCryptV2RootLilToon : MonoBehaviour
    {
        ...
        public void EncryptAvatar()
        {
            ...
            AvaCryptV2RootLilToon[] avaCryptRoots = encodedGameObject.GetComponentsInChildren<AvaCryptV2RootLilToon>();
            foreach (AvaCryptV2RootLilToon avaCryptRoot in avaCryptRoots)
            {
