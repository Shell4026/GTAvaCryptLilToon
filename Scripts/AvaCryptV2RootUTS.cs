...
{
    public class AvaCryptV2RootUTS : MonoBehaviour
    {
        ...
        public void EncryptAvatar()
        {
            ...
            AvaCryptV2RootUTS[] avaCryptRoots = encodedGameObject.GetComponentsInChildren<AvaCryptV2RootUTS>();
            foreach (AvaCryptV2RootUTS avaCryptRoot in avaCryptRoots)
            {
