...
Shader "UnityChanToonShader/Toon_DoubleShadeWithFeather_TransClipping_GT" {
    Properties {
...
//Outline
        ...
        [Toggle(_)]_EnableAvaCrypt ("enable", float) = 1

        [Toggle(_)]_BitKey0 ("bitkey0", float) = 0
        [Toggle(_)]_BitKey1 ("bitkey1", float) = 0
        [Toggle(_)]_BitKey2 ("bitkey2", float) = 0
        [Toggle(_)]_BitKey3 ("bitkey3", float) = 0

        [Toggle(_)]_BitKey4 ("bitkey4", float) = 0
        [Toggle(_)]_BitKey5 ("bitkey5", float) = 0
        [Toggle(_)]_BitKey6 ("bitkey6", float) = 0
        [Toggle(_)]_BitKey7 ("bitkey7", float) = 0

        [Toggle(_)] _BitKey8 ("bitkey8", float) = 0
        [Toggle(_)]_BitKey9 ("bitkey9", float) = 0
        [Toggle(_)]_BitKey10 ("bitkey10", float) = 0
        [Toggle(_)]_BitKey11 ("bitkey11", float) = 0

        [Toggle(_)]_BitKey12 ("bitkey12", float) = 0
        [Toggle(_)]_BitKey13 ("bitkey13", float) = 0
        [Toggle(_)]_BitKey14 ("bitkey14", float) = 0
        [Toggle(_)]_BitKey15 ("bitkey15", float) = 0

        [Toggle(_)]_BitKey16 ("bitkey16", float) = 0
        [Toggle(_)]_BitKey17 ("bitkey17", float) = 0
        [Toggle(_)]_BitKey18 ("bitkey18", float) = 0
        [Toggle(_)]_BitKey19 ("bitkey19", float) = 0

        [Toggle(_)]_BitKey20 ("bitkey20", float) = 0
        [Toggle(_)]_BitKey21 ("bitkey21", float) = 0
        [Toggle(_)]_BitKey22 ("bitkey22", float) = 0
        [Toggle(_)]_BitKey23 ("bitkey23", float) = 0

        [Toggle(_)]_BitKey24 ("bitkey24", float) = 0
        [Toggle(_)]_BitKey25 ("bitkey25", float) = 0
        [Toggle(_)]_BitKey26 ("bitkey26", float) = 0
        [Toggle(_)]_BitKey27 ("bitkey27", float) = 0

        [Toggle(_)]_BitKey28 ("bitkey28", float) = 0
        [Toggle(_)]_BitKey29 ("bitkey29", float) = 0
        [Toggle(_)]_BitKey30 ("bitkey30", float) = 0
        [Toggle(_)]_BitKey31 ("bitkey31", float) = 0
    }
    SubShader {
        Tags {
            "Queue"="AlphaTest"
...
//ToonCoreStart
        Pass {
            ...
            //
            #include "UCTS_DoubleShadeWithFeatherGT.cginc"
        ...
        Pass {
            ...
            //v.2.0.4
            #pragma multi_compile _IS_CLIPPING_TRANSMODE
            #include "UCTS_ShadowCasterGT.cginc"
            ENDCG
        }
//ToonCoreEnd
    }
